(function () {
    ...
    angular
        .module('app.product')
        .controller('AdminProductsListController', ['NgTableParams', '$scope', 'Product', AdminProductsListController]);

    function AdminProductsListController(NgTableParams, $scope, Product) {
